...
--
-- Name: attivitànonprogettuale; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."attivitànonprogettuale" (
    id public.posinteger NOT NULL,
    persona public.posinteger NOT NULL,
...
ALTER TABLE public."attivitànonprogettuale" OWNER TO postgres;
...
--
-- Data for Name: attivitànonprogettuale; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."attivitànonprogettuale" (id, persona, tipo, giorno, oredurata) FROM stdin;
\.
...
--
-- Name: attivitànonprogettuale attivitànonprogettuale_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."attivitànonprogettuale"
    ADD CONSTRAINT "attivitànonprogettuale_pkey" PRIMARY KEY (id);
...
--
-- Name: attivitànonprogettuale attivitànonprogettuale_persona_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."attivitànonprogettuale"
    ADD CONSTRAINT "attivitànonprogettuale_persona_fkey" FOREIGN KEY (persona) REFERENCES public.persona(id);
